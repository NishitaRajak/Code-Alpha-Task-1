...
<body>
  <section class="header-box fixed-bar ">
    ...
    <h2 class="brand"><a href="index.php"> NI<span style="color: red">S</span>HITA BLOGS</a></h2>
...
<!--top navigation -->
         ...
         <div id="mySidenav" class="sidenav">
            ...
            <div>
              ...
              <a href="https://www.instagram.com/__nishhitaaa__/" class="insg"><i class="fa fa-instagram"></i> Instagram</a>
              <a href="#" class="twit"><i class="fa fa-twitter"></i> Twitter</a>
              <a href="https://www.linkedin.com/in/nishita-rajak-782621220/" class="teleg"><i class="fa fa-telegram"></i> Telegram</a>
            </div>
            <div>
